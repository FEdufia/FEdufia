# Felix Edufia Agblemanyo
**PhD Candidate in Oceanography (Marine Biogeochemistry) · University of Delaware**
...
My PhD investigates the sources, transformations, and properties of surfactants in the Northwestern Atlantic Ocean, with emphasis on:

- Sea surface microlayer (SML) sampling and organic matter characterization
- Molecular-level surfactant analysis using LC-21T-FTICR-MS/MS
- Biological sources of surfactants via fluorescence spectroscopy and microbial community profiling
- Surfactant quantification and surface tension measurements
...
| Analytical | Computational | Field |
|---|---|---|
| GC-MS, LC-MS, FTICR-MS | R, Python, Bash scripting | Cruise planning & ocean sampling |
| Fluorescence & UV-Vis spectrophotometry | Multivariate statistics and bioinformatics | Estuarine and salt marsh sampling |
| DNA extraction & amplification for sequencing |||
| Surfactant quantification & strength characterization | | |
...
- Email: fedufia@udel.edu | felixedufia@gmail.com
